...
5. Generar gráficas (histograma, boxplot, dispersión, barras, línea de
   tiempo con promedio ± error estándar) sin escribir código.
...
`writexl`, `gridExtra` (este último se usa para armar el reporte en PDF).
